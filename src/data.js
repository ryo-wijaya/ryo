export const profile = {
  ...
  about:
    "Full stack software engineer in Singapore. Currently at Crédit Agricole Corporate & Investment Bank, where I mostly build backend services and data pipelines with Spring Boot, Spark Java, Kafka, Helm/Kubernetes/Docker, GitLab CI, and GCP. Outside of work, my interests are mostly into personal finance, racing sims,electric guitar, piano, drums, and amateur music production. I also enjoy bringing my dog out to places.",
};
...
export const projects = [
  {
    ...
    description:
      "AI-narrated portfolio digest for retail investors and traders.",
  },
  {
    name: "PetHub",
  ...
  },
  {
    ...
    description:
      "Personal Jekyll blog utilizing the open-source Chirpy Theme. Used for notes on tech and finance.",
  },
  {
...
export const skills = {
  Technologies: [
    ...
    { name: "Avro", icon: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/apacheavro.svg" },
    { name: "RESTful APIs" },
    ...
    { name: "Jakarta EE" },
    { name: "JUnit", icon: d("junit", "original") },
